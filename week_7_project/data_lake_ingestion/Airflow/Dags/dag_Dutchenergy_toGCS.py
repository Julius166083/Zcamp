...
COTEQ_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/coteq_electricity_{{ execution_date.strftime(\'%Y\') }}.csv'
COTEQ_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/coteq_electricity_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
RENDO_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/rendo_electricity_{{ execution_date.strftime(\'%Y\') }}.csv'
RENDO_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/rendo_electricity_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
STEDIN_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/stedin_electricity_{{ execution_date.strftime(\'%Y\') }}.csv'
STEDIN_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/stedin_electricity_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
#'WESTLAND-INFRA_ELECTRICITY_CSV_FILE_TEMPLATE' = AIRFLOW_HOME + '/datasets/energy/Electricity/westland-infra_electricity_{{ execution_date.strftime(\'%Y\') }}.csv'
#'WESTLAND-INFRA_ELECTRICITY_PARQUET_FILE_TEMPLATE' = AIRFLOW_HOME + '/datasets/energy/Electricity/westland-infra_electricity_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
ENDINET_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/endinet_electricity_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENDINET_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/endinet_electricity_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
ENDURIS_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/enduriselectricity_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENDURIS_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/enduriselectricity_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
ENEXIS_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/enexis_electricity_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENEXIS_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/enexis_electricity_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
LIANDER_ELECTRICITY_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/liander_electricity_{{ execution_date.strftime(\'0101%Y\') }}.csv'
LIANDER_ELECTRICITY_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Electricity/liander_electricity_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
COTEQ_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/coteq_gas_{{ execution_date.strftime(\'%Y\') }}.csv'
COTEQ_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/coteq_gas_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
RENDO_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/rendo_gas_{{ execution_date.strftime(\'%Y\') }}.csv'
RENDO_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/rendo_gas_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
STEDIN_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/stedin_gas_{{ execution_date.strftime(\'%Y\') }}.csv'
STEDIN_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/stedin_gas_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
#WESTLAND-INFRA_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/westland-infra_gas_{{ execution_date.strftime(\'%Y\') }}.csv'
#WESTLAND-INFRA_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/westland-infra_gas_{{ execution_date.strftime(\'%Y\') }}.parquet'
...
ENDINET_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/endinet_gas_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENDINET_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/endinet_gas_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
ENDURIS_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/endurisgas_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENDURIS_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/endurisgas_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
ENEXIS_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/enexis_gas_{{ execution_date.strftime(\'0101%Y\') }}.csv'
ENEXIS_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/enexis_gas_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
...
LIANDER_GAS_CSV_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/liander_gas_{{ execution_date.strftime(\'0101%Y\') }}.csv'
LIANDER_GAS_PARQUET_FILE_TEMPLATE = AIRFLOW_HOME + '/datasets/energy/Gas/liander_gas_{{ execution_date.strftime(\'0101%Y\') }}.parquet'
